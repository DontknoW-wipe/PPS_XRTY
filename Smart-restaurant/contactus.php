...
<html>
  ...
  <head>
    <title> Contact | Smart Restaurant </title>
  </head>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact Smart Restaurant ?</strong>
     <br>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <input type="submit" name="submit" value="Submit Feedback" type="button" id="submit" name="submit" class="btn btn-primary pull-right"/>    
        </form>
